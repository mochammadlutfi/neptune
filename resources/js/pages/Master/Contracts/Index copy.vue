<template>
    <div class="content">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <!-- Total Contracts -->
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-sm border border-blue-200 p-4 hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        <div class="text-2xl font-bold text-blue-700">{{ data?.meta?.total || 0 }}</div>
                        <div class="text-sm text-blue-600 font-medium">Total Kontrak</div>
                    </div>
                    <div class="bg-blue-500 rounded-full p-3">
                        <Icon icon="mingcute:file-line" class="text-white text-xl" />
                    </div>
                </div>
            </div>
            
            <!-- Active Contracts -->
            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl shadow-sm border border-green-200 p-4 hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                    ...
                    <div class="bg-green-500 rounded-full p-3">
                        <Icon icon="mingcute:check-circle-line" class="text-white text-xl" />
                    </div>
                </div>
            </div>
            
            <!-- Expiring Soon -->
            <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl shadow-sm border border-yellow-200 p-4 hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        <div class="text-2xl font-bold text-yellow-700">{{ stats.expiring_soon || 0 }}</div>
                        <div class="text-sm text-yellow-600 font-medium">Akan Berakhir</div>
                    </div>
                    <div class="bg-yellow-500 rounded-full p-3">
                        <Icon icon="mingcute:time-line" class="text-white text-xl" />
                    </div>
                </div>
            </div>
            
            <!-- Expired -->
            <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-xl shadow-sm border border-red-200 p-4 hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        <div class="text-2xl font-bold text-red-700">{{ stats.expired || 0 }}</div>
                        <div class="text-sm text-red-600 font-medium">Berakhir</div>
                    </div>
                    <div class="bg-red-500 rounded-full p-3">
                        <Icon icon="mingcute:close-circle-line" class="text-white text-xl" />
                    </div>
                </div>
            </div>
        </div>
