                ...
                <template #default>
                    <div class="overflow-x-auto">
                        <el-table class="base-table" :data="data?.data || []" @sort-change="sortChange"
                            ...
                            <el-table-column prop="oim_id" :label="$t('master.vessels.fields.oim_id')"
                                min-width="160" show-overflow-tooltip>
                              <template #default="scope">
                                <div class="text-sm">
                                  <span v-if="scope.row.oim">
                                    {{ scope.row.oim.name }}
                                  </span>
                            ...
                            <el-table-column prop="client_name" :label="$t('master.vessels.fields.client_name')"
                                min-width="160" show-overflow-tooltip>
                              <template #default="scope">
                                <div class="text-sm">
                            ...
                            <el-table-column prop="is_active" :label="$t('master.vessels.fields.status')" width="120"
                                sortable>
                                <template #default="scope">
                                    <el-tag :type="scope.row.is_active ? 'success' : 'danger'" size="small">
                                        {{ scope.row.is_active ? $t('master.vessels.status.active') : $t('master.vessels.status.inactive') }}
                                    </el-tag>
                                </template>
                            </el-table-column>
