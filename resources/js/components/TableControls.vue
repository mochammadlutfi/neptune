    ...
    <div class="border-b border-gray-200">
        ...
        >
            ...
            <div class="p-4 flex flex-col sm:flex-row gap-4 sm:items-center justify-between">
                <!-- Left side controls - Search and Filters -->
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div v-if="selectedRows.length > 0 && showBulkActions" class="flex items-center gap-2">
                        <span class="text-sm text-gray-600">
                            {{ selectedRows.length }} {{ $t('common.actions.selected') }}
                        </span>
                        <slot name="bulk-actions" :selectedRows="selectedRows">
                            <el-button @click="$emit('bulk-export', selectedRows)">
                                <Icon icon="mingcute:download-line" class="mr-1" />
                                {{ $t('common.bulk_actions.export_selected') }}
                            </el-button>
                            <el-button type="danger" @click="$emit('bulk-delete', selectedRows)">
                                <Icon icon="mingcute:delete-2-line" class="mr-1" />
                                {{ $t('common.bulk_actions.delete_selected') }}
                            </el-button>
                        </slot>
                    </div>
